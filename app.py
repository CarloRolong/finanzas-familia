...
# --- TRUCO DE SEGURIDAD (BLINDADO) ---
if not os.path.exists("credentials.json"):
    # Si estamos en la nube, decodificamos el secreto seguro
    try:
        if "credenciales_seguras" in st.secrets:
            ...
            st.error("Error: No encontré el secreto 'credenciales_seguras'")
    except Exception as e:
        st.error(f"Error al crear credenciales: {e}")
# -------------------------------------
